...
namespace PlanoAprendizado.Models
{
    public class Expense
    {
        ...
        [Display(Name = "Conta:")]
        public int? CaptureId { get; set; } //A interrogação indica que essa variável pode ser nula
        [Display(Name = "Conta:")]
        public Capture? Capture { get; set; } //Recebe dados da classe Captures
        ...
        [Display(Name = "Saldo Banco:")]
        [DisplayFormat(DataFormatString = "{0:C2}", ApplyFormatInEditMode = true)]
        public float BankValueMoment { get; set; }

        [Display(Name = "Saldo Empresa:")]
        [DisplayFormat(DataFormatString = "{0:C2}", ApplyFormatInEditMode = true)]
